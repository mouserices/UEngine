...
public sealed class DestroyInputUnitSystem : ICleanupSystem {

    readonly IGroup<UnitEntity> _group;
    readonly List<UnitEntity> _buffer = new List<UnitEntity>();

    public DestroyInputUnitSystem(Contexts contexts) {
        _group = contexts.unit.GetGroup(UnitMatcher.Input);
    }
