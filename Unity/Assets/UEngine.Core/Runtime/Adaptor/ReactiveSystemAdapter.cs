...
namespace UEngine
{   
    public class ReactiveSystemAdapter : CrossBindingAdaptor
    {
        ...
        public class Adapter : Entitas.ReactiveSystem<UEngine.EntityAdapter.Adapter>, CrossBindingAdaptorType
        {
            ...
            public Adapter():base((ContextAdapter.Adapter)null)
            {

            }

            public Adapter(ILRuntime.Runtime.Enviorment.AppDomain appdomain, ILTypeInstance instance) :base((ICollector<EntityAdapter.Adapter>)null)
            {
                this.appdomain = appdomain;
                this.instance = instance;

                // :base((ContextAdapter.Adapter)null);
