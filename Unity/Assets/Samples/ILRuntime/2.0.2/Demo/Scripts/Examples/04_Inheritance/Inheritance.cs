...
public class Inheritance : MonoBehaviour
{
    ...
    void OnHotFixLoaded()
    {
        ...
        obj = appdomain.Instantiate<TestClassBase>("HotFix_Project.TestInheritance",new object[]{"ww"});
        Debug.Log("现在来调用成员方法");
        obj.TestAbstract(123);
        obj.TestVirtual("Hello");
        obj.Value = 233;
        Debug.LogFormat("obj.Value={0}", obj.Value);
        Debug.LogFormat("obj.name={0}", obj.GetName());
        ...
        obj.Value = 2333333;
        Debug.LogFormat("obj.Value={0} obj.name={1}", obj.Value,obj.GetName());
    }
