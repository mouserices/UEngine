...
public sealed class DestroyDamageUnitSystem : ICleanupSystem {

    readonly IGroup<UnitEntity> _group;
    readonly List<UnitEntity> _buffer = new List<UnitEntity>();

    public DestroyDamageUnitSystem(Contexts contexts) {
        _group = contexts.unit.GetGroup(UnitMatcher.Damage);
    }
