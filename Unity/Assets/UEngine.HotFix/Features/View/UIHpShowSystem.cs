...
public class UIHpShowSystem : IExecuteSystem
{
    ...
    private IGroup<UnitEntity> m_Group;
    ...
    {
        m_Group = contexts.unit.GetGroup(UnitMatcher.AllOf(UnitMatcher.Numeric)
            .NoneOf(UnitMatcher.MainPlayer, UnitMatcher.MirrorTag));
