...
{
    public static bool CheckState(this UnitEntity gameEntity, StateType stateType)
    {
    ...
    public static void AddNumericModifier(this UnitEntity gameEntity, NumericType t, BaseModifier modifier)
    {
    ...
    /// <param name="gameEntity"></param>
    /// <param name="t"></param>
    public static void CalculateNumeric(this UnitEntity gameEntity, NumericType t)
    {
        var modifierDic = gameEntity.numericModifier.Modifiers;
        if (modifierDic.TryGetValue(t, out var modifiers))
        {
    ...
    /// </summary>
    /// <param name="t"></param>
    public static float GetNumeric(this UnitEntity gameEntity,NumericType t)
    {
        float value = 0;
    ...
    public static void ChangeNumeric(this UnitEntity gameEntity,NumericType t,float changeValue)
    {
        if (gameEntity.numeric.Numerics.ContainsKey(t))
        {
