...
Shader "YanJia/Effect/FresnelOutLIneCutoff" 
{
    Properties
    {
        _TintColor ("Color", Color) = (0.5,0.5,0.5,1)
        _MainTex("Mask Tex", 2D) = "white" {}
        _MaskTex("Dissolution Tex", 2D) = "white" {}
    ...
    SubShader 
    {
        ...
        Pass 
        {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR 
            {
                ...
                fixed4 finalRGBA = fixed4(finalColor,alpha* _TintColor.a);
                fixed cutoff = tex2D(_MaskTex, i.uv).r;
                clip(cutoff - i.color.a);
